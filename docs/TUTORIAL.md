...
典型用法：用 Kimi Code 等 AI 打开本仓库文件夹，说
...
**更重要的是"人和 AI 怎么配合"**——想清楚→说清楚→AI 动手→人验证→反馈修正→留痕，
每一步都有具体的做法和本项目真实的正反案例（比如"报错原文永远比转述值钱"、
"让 AI 先列计划再开工"、"预期 vs 实际的测试表格"）。
**请务必读 [docs/AI_COLLABORATION.md](AI_COLLABORATION.md)，它比本教材任何一章都重要。**
